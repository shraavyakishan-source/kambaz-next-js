export default function Lab1(){
    return (
        <><div id="wd-lab1">
            <h2>Lab1</h2>
        </div><h3>HTML Examples</h3><div id="wd-h-tag">
                <h4>Heading tags</h4>
            </div>
            <div id="wd-p-tag"></div>
                <h4>Paragraph tag</h4>
                ...
                <div id="wd-forms">
                    ...
                    <form id="wd-text-fields">
                        ...
                        <input type="text" title="Shraavya" id="wd-text-fields-first-name" /> <br />
                        <label htmlFor="wd-text-fields-last-name">Last name:</label>
                        <input type="text" defaultValue="Bharadwaj" title="The last name" id="wd-text-fields-last-name" />
                    </form>
                </div>
                <h4>Text boxes</h4>
                <label>Biography:</label><br />
                <textarea id="wd-textarea" cols={30} rows={10}>Lorem Ipsum is simply dummy text of the printing
